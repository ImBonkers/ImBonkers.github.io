...
$(document).ready(function(){
    ...
    createRowElements(document.getElementById("AS"), "as")
    createRowElements(document.getElementById("LifeSteal"), "lifesteal")
    createRowElements(document.getElementById("Spellvamp"), "spellvamp")
    createRowElements(document.getElementById("Omnivamp"), "omnivamp")
